...
# ---- Editorial Journal palette (mirrors theme.scss) ----
col_ink     <- "#15181D"   # primary ink
col_accent  <- "#8C2F39"   # editorial red
col_paper   <- "#F7F3EC"   # paper background
col_paper2  <- "#EFE9DC"
col_rule    <- "#D8CFBC"
col_muted   <- "#6B6459"
col_forest  <- "#3C6E47"   # secondary — natural green
col_ochre   <- "#B8812B"   # secondary — warm ochre
col_slate   <- "#3F5E8C"   # secondary — cool slate
col_plum    <- "#5C3A50"   # secondary — deep plum

# Base font family for plotly charts
chart_font_family <- "Source Serif 4, Georgia, serif"

# Chart colors — ink + accent + warm/cool editorial tones
chart_colors <- c(col_ink, col_accent, col_forest, col_slate, col_ochre, col_plum, col_muted)
